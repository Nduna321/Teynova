...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      image: "/images/After-Sales Support.jpg",
      features: [
        "Warranty support",
        "Replacement parts",
  ...
  const industries = [
    ...
    {
      name: "Skincare",
      description: " Spas, dermatology clinics, and beauty salons",
      image: "/images/mask care.jpg",
      services: [
        "Skincare tools & devices (facial steamers, cleansing brushes)",
        "Personal care & hygiene products",
        "Skin diagnostic & analysis tools",
        "Creams, serums, masks, and other skincare consumables",
      ],
    },
    {
      name: "Research",
      description: "Research institutions and development centers",
      image: "/images/reseach.jpg",
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" asChild className="touch-manipulation bg-transparent">
                <a href="tel:+263788303009" className="text-white border-white hover:bg-white hover:text-red-600">
                  Call Now
                </a>
              </Button>
            </div>
