...
import { Shield, Beaker, Sparkles, Bug, Phone, Mail, MessageCircle } from "lucide-react"
...
export default function HomePage() {
  const services = [
    ...
    },
    {
      ...
      description: "Premium personal care and beauty products for all skin types.",
      image: "/images/teyne-mask-1.jpg",
    },
    {
      icon: <Bug className="h-12 w-12 text-red-600" />,
      title: "Pest Control",
      description: "Effective chemical solutions for pest management and control.",
      image: "/images/lab-equipment-2.jpg",
    },
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6 text-lg">
                Teynova Polychems is your trusted partner for high-quality laboratory equipment, safety gear, cosmetic
                products, and chemical solutions. We serve schools, universities, research institutions, hospitals, and
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" variant="secondary" asChild className="touch-manipulation">
              <a href="tel:+263783030009" className="flex items-center space-x-2">
